            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-4xl font-bold">Nevada Cybercrime Statistics</h1>
                  <p className="text-fbi-blue-100">Las Vegas Field Office - 2020-2024 Analysis</p>
                </div>
              </div>
            </div>
          </div>
