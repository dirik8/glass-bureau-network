...
const FloridaStats: React.FC = () => {
  const yearlyData = [
    { year: 2024, cases: 2847, losses: '$78.3M', avgLoss: '$27.5K' },
    { year: 2023, cases: 2431, losses: '$65.7M', avgLoss: '$27.0K' },
    { year: 2022, cases: 1896, losses: '$49.2M', avgLoss: '$25.9K' },
    { year: 2021, cases: 1534, losses: '$37.8M', avgLoss: '$24.6K' },
    { year: 2020, cases: 1092, losses: '$24.1M', avgLoss: '$22.1K' }
  ];

  const topScamTypes = [
    { type: 'Investment/Trading Platforms', percentage: 32, cases: 911, losses: '$25.1M' },
    { type: 'Romance/Relationship', percentage: 26, cases: 740, losses: '$20.4M' },
    { type: 'Business Email Compromise', percentage: 19, cases: 541, losses: '$14.9M' },
    { type: 'Tech Support', percentage: 13, cases: 370, losses: '$10.2M' },
    { type: 'Employment/Job', percentage: 10, cases: 285, losses: '$7.8M' }
  ];

  const regionalHotspots = [
    { city: 'Miami-Dade', cases: 967, losses: '$26.7M' },
    { city: 'Broward', cases: 743, losses: '$20.5M' },
    { city: 'Orange (Orlando)', cases: 521, losses: '$14.4M' },
    { city: 'Hillsborough (Tampa)', cases: 398, losses: '$11.0M' },
    { city: 'Other Areas', cases: 218, losses: '$5.7M' }
  ];
            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-4xl font-bold">Florida Cybercrime Statistics</h1>
                  <p className="text-primary-foreground/80">Miami Field Office - 2020-2024 Analysis</p>
                </div>
              </div>
              <div className="bg-primary/80 p-6 rounded-lg">
                <p className="text-xl text-primary-foreground/90 leading-relaxed">
                  Florida ranks third nationally in cybercrime losses, with a 160% increase in reported incidents 
                  over the past four years. The state's large retiree population makes it particularly vulnerable 
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">9,800</div>
                <div className="text-sm text-muted-foreground">Total Cases (2020-2024)</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-600">$255.1M</div>
                <div className="text-sm text-muted-foreground">Total Losses</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-500">160%</div>
                <div className="text-sm text-muted-foreground">4-Year Increase</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">$26.0K</div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <Card className="government-card border-red-200">
                ...
                <CardContent className="space-y-4">
                  <p className="text-foreground">
                    Florida victims should report cybercrime immediately to increase recovery chances 
              ...
              <Card className="government-card border-primary">
                ...
                <CardContent className="space-y-4">
                  <p className="text-foreground">
                    Access Florida-specific prevention programs, educational materials, and 
                  ...
                  <div className="space-y-2">
                    ...
                    <Button variant="outline" className="w-full" asChild>
                      <Link to="/case-studies">Florida Case Studies</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
