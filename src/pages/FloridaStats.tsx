            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-fbi-blue-100">Miami Field Office - 2020-2024 Analysis</p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-fbi-blue">9,800</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-fbi-blue">$26.0K</div>
