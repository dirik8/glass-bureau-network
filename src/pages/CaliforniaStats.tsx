...
const CaliforniaStats: React.FC = () => {
  const yearlyData = [
    { year: 2024, cases: 3247, losses: '$89.2M', avgLoss: '$27.5K' },
    { year: 2023, cases: 2891, losses: '$76.8M', avgLoss: '$26.6K' },
    { year: 2022, cases: 2156, losses: '$58.4M', avgLoss: '$27.1K' },
    { year: 2021, cases: 1834, losses: '$45.2M', avgLoss: '$24.6K' },
    { year: 2020, cases: 1245, losses: '$28.9M', avgLoss: '$23.2K' }
  ];

  const topScamTypes = [
    { type: 'Investment/Trading Platforms', percentage: 34, cases: 1104, losses: '$30.3M' },
    { type: 'Romance/Relationship', percentage: 23, cases: 747, losses: '$20.5M' },
    { type: 'Business Email Compromise', percentage: 18, cases: 584, losses: '$16.1M' },
    { type: 'Tech Support', percentage: 15, cases: 487, losses: '$13.4M' },
    { type: 'Employment/Job', percentage: 10, cases: 325, losses: '$8.9M' }
  ];

  const regionalHotspots = [
    { city: 'Los Angeles', cases: 1247, losses: '$34.2M' },
    { city: 'San Francisco', cases: 892, losses: '$28.7M' },
    { city: 'San Diego', cases: 634, losses: '$18.9M' },
    { city: 'Sacramento', cases: 298, losses: '$7.4M' },
    { city: 'Fresno', city2: 'Other Areas', cases: 176, losses: '$12.1M' }
  ];
            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-4xl font-bold">California Cybercrime Statistics</h1>
                  <p className="text-fbi-blue-100">Los Angeles Field Office - 2020-2024 Analysis</p>
                </div>
              </div>
              <div className="bg-fbi-blue-900/50 p-6 rounded-lg">
                <p className="text-xl text-fbi-blue-100 leading-relaxed">
                  California leads the nation in both cybercrime incidents and financial losses, 
                  with cryptocurrency-related fraud showing a 161% increase over the past four years. 
                  This report provides comprehensive analysis for law enforcement and public awareness.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-fbi-blue">11,373</div>
                <div className="text-sm text-government-gray-600">Total Cases (2020-2024)</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-600">$298.5M</div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <Card className="government-card border-red-200">
                ...
                <CardContent className="space-y-4">
                  <p className="text-government-gray-700">
                    California victims should report cybercrime immediately to increase recovery chances 
                  ...
                  <div className="space-y-2">
                    ...
                    <Button variant="outline" className="w-full" size="lg">
                      ...
                      California Hotline: (438) 602-5895
                    </Button>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="government-card border-fbi-blue">
                ...
                <CardContent className="space-y-4">
                  <p className="text-government-gray-700">
                    Access California-specific prevention programs, educational materials, and 
                  ...
                  <div className="space-y-2">
                    ...
                    <Button variant="outline" className="w-full" asChild>
                      <Link to="/case-studies">California Case Studies</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
