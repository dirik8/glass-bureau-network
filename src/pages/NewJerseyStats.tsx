            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-4xl font-bold">New Jersey Cybercrime Statistics</h1>
                  <p className="text-fbi-blue-100">Newark Field Office - 2020-2024 Analysis</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="government-card border-red-200">
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full" size="lg">
                  ...
                  New Jersey Hotline: (973) 792-3000
                </Button>
              </CardContent>
            </Card>
          </div>
